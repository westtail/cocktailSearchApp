...
User.find_or_create_by!(email: 'test2@a.a') do |user|
    user.name ='テスト2'
...
Cocktail.first_or_create([
    ...
    {name: "ウイスキーロック", base_alcohol: "ウイスキー", taste: "辛い", alcohol_percentage: "強い(30~40%)", glass_type:"ロング",cocktail_recipe: "コップに氷とウイスキーを入れてステアして完成",image: open("#{Rails.root}/app/assets/images/ウイスキーロック.JPG"), user_id: 2},
    {name: "ウイスキーショット", base_alcohol: "ウイスキー", taste: "辛い", alcohol_percentage: "強い(30~40%)", glass_type:"ショット",cocktail_recipe: "コップに氷とウイスキーを入れてステアして完成",image: open("#{Rails.root}/app/assets/images/ウイスキーロック.JPG"), user_id: 2}
])
